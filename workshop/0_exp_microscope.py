...
def print_microscope(
    ...
    # Normalize popularity for coloring
    ...
    norm_popularity /= (max_pop - min_pop)
    norm_popularity = 1 - norm_popularity

    # use log scale

    # print(norm_popularity)
     # norm_popularity = 0.9 * (1 -   norm_popularity)

    cmap = plt.cm.viridis

    colors = cmap(norm_popularity)
